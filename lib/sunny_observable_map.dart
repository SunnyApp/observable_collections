...
import 'package:observable_collections/observable_extensions.dart';
...
class SunnyObservableMap<K, V> extends ObservableMap<K, V> with LoggingMixin {
  ...
  Map<KK, VV> safeCast<KK, VV>() => Map.fromEntries(
      this.entries.map((e) => MapEntry<KK, VV>(e.key as KK, e.value as VV)));
